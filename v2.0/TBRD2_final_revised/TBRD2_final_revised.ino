...
String log_data = "";
int logger_stat = 0;
String header = "date,time,distance,cnt,pwm,uid";
//-------------------------------------------------------------------
String pre_msg = "";
int pre_stage = 0;
//------------------------------------------------------------------
...
String rtc() {
  ...
  sprintf(date, "%02d/%02d/%02d", year, month, monthDay);
